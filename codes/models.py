...
class HPRE(KGEModel):
    ...
    def func(self, head, rel, tail, batch_type):
        ...
        phase_relation, head_relation, tail_relation = torch.chunk(rel, 3, dim=2)
        ...
        head_relation = torch.abs(head_relation)

        tail_relation = torch.abs(tail_relation)

        r_score = mod_head * head_relation - mod_tail * tail_relation
